...
`r intervalAtMax`, corresponding to a maximun value of `r max(aspi$aspi)`.
...
There are `r numMissingValues` missing observations in this dataset, which
...
`r mean2` and the new median value is `r median2`.  The mean value is of
